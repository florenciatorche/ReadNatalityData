clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2015.log, replace 
set more off

** -----------------------------------------------; 
** This program reads the 2015 Restricted-Use  
** NCHS Natality Data File 
** by Hye Jee Kim, hyejk@stanford.edu,  Thur Aug 18 2022 
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 ///
      str OSTATE 24-25 str XOSTATE 26-27 str OCNTYFIPS 28-30 str OCNTYPOP 31 ///
	  ...
	  str MRCNTRY 85-86 str XMRSTATE 87-88 str MRSTATEPSTL 89-90 ///
	  str MRCNTYFIPS 91-93 str MRCITYFIPS 94-98 ///
	  str RCNTY_POP 99 str RCITY_POP 100 str CITYLIM 101 str F_LIMIT 102 ///
	  str RECTYPE 103 str RESTATUS 104 ///   
	  str MRACE31 105-106 str MRACE6 107 str MRACE15 108-109 /// 
	  str MBRACE 110 str MRACEIMP 111 ///
	  ...
	  str FRACE31 151-152 str FRACE6 153 str FRACE15 154-155 str FBRACE 156 ///
	  ...
	  str COMBGST_IMP 488 str OBGEST_FLG 489 str COMBGEST 490-491 ///
	  ...
	  str uBFacil 1330 str uRF_Diab 1331 str uRF_Chype 1332 str uRF_Phype 1333 ///
	  str uRf_Ehype 1334 ///
	  str uME_Forc 1335 str uME_Vacu 1336 ///
	  str uOB_Indu 1337 str uLD_Bree 1338 ///
	  str uCA_Anen 1340 str uCA_Spina 1341 str uCA_Omph 1342 str uCA_Clip 1343 /// 
	  str uCA_Hern 1344 str uCA_Down 1345 ///
	  using "FILEPATH/NATL2015USPS.AllCnty/NATL2015US.AllCnty.txt" 

** The above line should contain
** the complete path and name of the raw data file.
	  
** The following line should contain the path to your output '.dta' (unlabeled) file ;
save "FILEPATH/RestrictedVitalStatistics_Natality_2015.dta", replace 
destring, replace
...
lab var MBCNTRY "Mother's Birth Country Code" 
...
lab def MRCNTYFIPS1 999 "Foreign"
...
lab var MBRACE "Bridged Race Mother" 
...
lab def MBRACE1 0 "Other (not classified as White or Black)" 1 "White" 2 "Black" ///
                3 "American Indian or Alaskan Native" 4 "Asian or Pacific Island" 
...
lab var FAGECOMB "Father's Combined Age (Revised)" // in years
...
lab var FBRACE	"Bridged Race Father"
// variable labels different for US and all Outlying Areas of the United States except Puerto Rico
// and for Puerto Rico (0 = Puerto Rico label, 1 2 same, 3 4 = US label)			   
lab def FBRACE1 0 "Other (not classified as White or Black)" 1 "White" 2 "Black" ///
                3 "American Indian or Alaskan Native" 4 "Asian or Pacific Island" 
lab val FBRACE FBRACE1 
tab FBRACE, mi //  9 code presumably unknown, not in codebook  
...
lab def PRIORLIVE1 99 "Unknown or not stated"
lab val PRIORLIVE PRIORLIVE1 
tab PRIORLIVE, mi

lab var PRIORDEAD "Prior Births Now Dead"
lab def PRIORDEAD1 99 "Unknown or not stated"
lab val PRIORDEAD PRIORDEAD1 
tab PRIORDEAD, mi 
...
lab var PREVIS "Number of Prenatal Visits (Revised)" 
...
lab def CIG_01 98 "98 or more cigarettes daily" 99 "Unknown or not stated"
lab val CIG_0 CIG_01 
tab CIG_0, mi 

lab var CIG_1 "Cigarettes 1st Trimester" 
lab def CIG_11 98 "98 or more cigarettes daily" 99 "Unknown or not stated"
lab val CIG_1 CIG_11
tab CIG_1, mi

lab var CIG_2 "Cigarettes 2nd Trimester" 
lab def CIG_21 98 "98 or more cigarettes daily" 99 "Unknown or not stated"
lab val CIG_2 CIG_21
tab CIG_2, mi

lab var CIG_3 "Cigarettes 3rd Trimester" 
lab def CIG_31 98 "98 or more cigarettes daily" 99 "Unknown or not stated"
lab val CIG_3 CIG_31
tab CIG_3, mi

lab var CIG0_R "Cigarettes Before Pregnancy Recode" 
lab def CIG0_R1 0 "Nonsmoker" 1 "1-5" 2 "6-10" 3 "11-20" 4 "21-40" 5 "41 or more" ///
                6 "Unknown or not stated"
lab val CIG0_R CIG0_R1 
tab CIG0_R, mi

lab var CIG1_R "Cigarettes 1st Trimester Recode" 
lab def CIG1_R1 0 "Nonsmoker" 1 "1-5" 2 "6-10" 3 "11-20" 4 "21-40" 5 "41 or more" ///
                6 "Unknown or not stated"
lab val CIG1_R CIG1_R1 
tab CIG1_R, mi

lab var CIG2_R "Cigarettes 2nd Trimester Recode" 
lab def CIG2_R1 0 "Nonsmoker" 1 "1-5" 2 "6-10" 3 "11-20" 4 "21-40" 5 "41 or more" ///
                6 "Unknown or not stated"
lab val CIG2_R CIG2_R1 
tab CIG2_R, mi

lab var CIG3_R "Cigarettes 3rd Trimester Recode" 
lab def CIG3_R1 0 "Nonsmoker" 1 "1-5" 2 "6-10" 3 "11-20" 4 "21-40" 5 "41 or more" ///
                6 "Not stated / Not on certificate"
lab val CIG3_R CIG3_R1 
tab CIG3_R, mi

lab var F_CIGS_0 "Reporting Flag for Cigarettes before Pregnancy" 
lab def F_CIGS_01 0 "Non-Reporting" 1 "Reporting"
lab val F_CIGS_0 F_CIGS_01 
tab F_CIGS_0, mi 

lab var F_CIGS_1 "Reporting Flag for Cigarettes 1st Trimester" 
lab def F_CIGS_11 0 "Non-Reporting" 1 "Reporting"
lab val F_CIGS_1 F_CIGS_11 
tab F_CIGS_1, mi  

lab var F_CIGS_2 "Reporting Flag for Cigarettes 2nd Trimester" 
lab def F_CIGS_21 0 "Non-Reporting" 1 "Reporting"
lab val F_CIGS_2 F_CIGS_21 
tab F_CIGS_2, mi  

lab var F_CIGS_3 "Reporting Flag for Cigarettes 3rd Trimester" 
lab def F_CIGS_31 0 "Non-Reporting" 1 "Reporting"
lab val F_CIGS_3 F_CIGS_31 
tab F_CIGS_3, mi  
...
lab var RF_INFTR "Infertility Treatment" // use reporting flag in field 319 for 2015
...
lab var RF_CESARN "Previous Cesareans Number"
lab define RF_CESARN1 0 "None" 99 "Unknown or not stated"
lab val RF_CESARN RF_CESARN1
tab RF_CESARN, mi 

lab var F_RF_CESAR "Reporting Flag for Previous Cesarean" 
...
lab var NO_INFEC "No Infections Checked" 
...
lab var DMETH_REC "Delivery Method Recode Combined"
...
lab var NO_MMORB "No Maternal Morbidity Checked"
...
lab var APGAR10 "Ten Minute APGAR Score" // use reporting flag in field 126 for 2015 
lab def APGAR101 88 "Not applicable" 99 "Unknown or not stated"
lab val APGAR10 APGAR101 
tab APGAR10, mi
				
lab var APGAR10R "Ten Minute APGAR Score Recode" // use reporting flag in field 126 for 2015 
...
lab var COMBGST_IMP "Combined Gestation Imputed"
lab def COMBGST_IMP1 1 "Combined Gestation is imputed" // missing = not imputed
lab val COMBGST_IMP COMBGST_IMP1
tab COMBGST_IMP, mi 		 
...
lab var LMPUSED "Computed (LMP) Gestation Used Flag"
lab def LMPUSED1 1 "LMP used for gestation" // missing = not used 
...
lab var F_AB_VENT "Reporting Flag for Assisted Ventilation" 
...
lab var F_CA_CLEFT "Reporting Flag for Cleft Plate Alone"
...
lab var uBFacil "Place of Birth"
lab def uBFacil1 1 "Hospital" 2 "Freestanding Birthing Center" ///
                 3 "Clinic / Doctor's Office" 4 "Residence" 5 "Other" 9 "Unknown"
lab val uBFacil uBFacil1 
tab uBFacil, mi
 
lab var uRF_Diab "Diabetes"

lab var uRF_Chype "Chronic Hypertension"

lab var uRF_Phype "Prepregnacy Associated Hypertension"
 
lab var uRf_Ehype "Eclampsia"

lab var uME_Forc "Forceps"

lab var uME_Vacu "Vacuum"

lab var uOB_Indu "Induction of Labor"

lab var uLD_Bree "Breech" 

lab var uCA_Anen "Anencephalus"

lab var uCA_Spina "Spina Bifida / Meningocele"

lab var uCA_Omph "Omphalocele / Gastroschisis"

lab var uCA_Clip "Cleft Lip / Palate"

lab var uCA_Hern "Diaphragmatic Hernia"

lab var uCA_Down "Down Syndrome"

foreach x of varlist uRF_Diab uRF_Chype uRF_Phype uRf_Ehype uME_Forc uME_Vacu uOB_Indu uLD_Bree uCA_Anen uCA_Spina uCA_Omph uCA_Clip uCA_Hern uCA_Down {
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2015_Labeled.dta", replace 
