clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2019.log, replace 
set more off
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 /// 
	  ...
	  using "FILEPATH/nat2019ps.AllCnty.txt" 
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2019.dta", replace
destring, replace
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2019_Labeled.dta", replace 
