clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2018.log, replace 
set more off
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2018_Labeled.dta", replace 
