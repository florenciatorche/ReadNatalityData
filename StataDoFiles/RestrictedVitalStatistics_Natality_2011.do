clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2011.log, replace 
set more off
...
infix str VERSION 7 ///
	  ...
	  str OSTATE 30-31 str XOSTATE 32-33 str OCNTYFIPS 37-39 str OCNTYPOP 40 /// 
	  str BFACIL 41 str UBFACIL 42 str BFACIL3 59 /// 
	  str DOBM_IMP 69 str DOBM_BYP 74 ///
	  str MAGE_IMPFLG 87 MAGE_REPFLG 88 str MAGER 89-90 ///
	  str MAGER14 91-92 str MAGER9 93 ///
      ...
      str FAGERPT_FLG 175 str FAGECOMB 182-183 str UFAGECOMB 184-185 ///
	  str FAGEREC11 186-187 ///
	  ...
	  str RF_FEDRG 322 str RF_ARTEC 323 str RF_CESAR 324 ///
	  str RF_CESARN 325-326 str RF_CES_BYP 327 ///
	  str URF_DIAB 331 str URF_CHYPER 335 str URF_PHYPER 336 str URF_ECLAM 337 ///
	  str IP_GONN 345 str IP_SYPH 346 str IP_CHLAM 348 str IP_HEPB 349 ///
	  str IP_HEPC 350 /// 
	  ...
	  str LD_INDL 365 str LD_AUGM 366 str LD_STER 368 str LD_ANTI 369 ///
	  str LD_CHOR 370 str LD_MECS 371 str LD_FINT 372 str LD_ANES 373 ///
	  ...
	  str F_CLINEST 573 ///
	  str F_APGAR5 574 str F_TOBACO 575 str F_M_HT 576 ///
	  str F_PWGT 577 str F_DWGT 578 ///
	  str F_WIC 579 str F_PAY 580 str F_BFED 581 /// 
	  ...
	  str F_WTGAIN 648 str F_MAR_G 652 /// 
	  str F_MPCB 668 ///
	  str F_TPCV 671 ///
...
lab def MAGER141 1 "Under 15 Years" 03 "15 years" 04 "16 years" 05 "17 years" ///
...
lab def MRACE1 01 "White" 02 "Black" 03 "American Indian or Alaskan Native" ///
			  ...
			  00 "Other races (Puerto Rico Only)" ///
...
save "/FILEPATH/RestrictedVitalStatistics_Natality_2011_Labeled.dta", replace 
