clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2017.log, replace 
set more off
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 ///
	  ...
	  using "FILEPATH/NATL2017USPS.AllCnty/NATL2017PS.AllCnty.txt" // enter FILEPATH

** The above line should contain
** the complete path and name of the raw data file.

** The following line should contain the path to your output '.dta' (unlabeled) file ;
save "FILEPATH/RestrictedVitalStatistics_Natality_2017.dta", replace // enter FILEPATH
destring, replace
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2017_Labeled.dta", replace
