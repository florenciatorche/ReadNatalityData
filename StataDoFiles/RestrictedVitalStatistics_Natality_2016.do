clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2016.log, replace 
set more off
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 ///
	  ...
	  str MRCNTYFIPS 91-93 str MRCITYFIPS 94-98 str RCNTY_POP 99 str RCITY_POP 100 ///
	  str CITYLIM 101 str F_LIMIT 102 str RECTYPE 103 ///
	  str RESTATUS 104 /// 
	  ...
	  using "FILEPATH/NATL2016USPS.AllCnty/NATL2016US.AllCnty.txt" 
	  
** The above line should contain
** the complete path and name of the raw data file.
	  
** The following line should contain the path to your output '.dta' (unlabeled) file ;
save "FILEPATH/RestrictedVitalStatistics_Natality_2016.dta", replace // enter FILEPATH
destring, replace
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2016_Labeled.dta", replace 
