...
** by Hye Jee Kim, hyejk@stanford.edu,  Sun Oct 23 2023
...
cd "FILEPATH" 
log using RestrictedVitalStatistics_Natality_2022.log, replace 
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 /// 
	  ...
	  using "FILEPATH/NATL2022US.AllCnty.txt" 
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2022.dta", replace
destring, replace
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2022_Labeled.dta", replace 
