...
** by Hye Jee Kim, hyejk@stanford.edu,  Thur Aug 23 2023
...
cd "FILEPATH" 
log using RestrictedVitalStatistics_Natality_2020.log, replace 
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 /// 
	  ...
	  using "FILEPATH/NATL2020us.AllCnty.txt" 
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2020.dta", replace
destring, replace
...
// XOSTATE - in 2019, not in 2020 codebook 
...
// 000 = Other Outlying Areas of the US; All other labels = Puerto Rico
...
// 2019 label = "Mother's Age Recode 41"
...
// MBSTATE - in 2019, not in 2020 codebook 
// Variable clearly exists and is the same, though, so using 2019 codebook 
...
// XMRSTATE - in 2019, not in 2020 codebook 
// Variable clearly exists and is the same, though, so using 2019 codebook 
...
// MRCITYFIPS - in 2019, not in 2020 codebook 
// Variable clearly exists and is the same, though, so using 2019 codebook 
...
// CITYLIM - in 2019, not in 2020 codebook 
// Variable clearly exists and is the same, though, so using 2019 codebook 
...
// F_LIMIT - in 2019, not in 2020 codebook
// Variable clearly exists and is the same, though, so using 2019 codebook 
...
// MBRACE in 2019, not in 2020 (no observations)
...
// str F_APGAR10 451 -  empty variable
// codebook note at APGAR10: use reporting flag in field 126 
...
save "FILEPATH/RestrictedVitalStatistics_Natality_2020_Labeled.dta", replace 
