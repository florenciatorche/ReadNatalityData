** Created by Gonzalo Torres Oct 1, 2024
...
** Reading in File **  
 ...
 infix   str  DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 /// 
    ...
    str  BFACIL 32 str F_BFACIL 33 str BFACIL3 50 ///
    ...
    str  MRCNTRY 85-86 str MRTERR 89-90 ///
    str  RCNTY 91-93 ///  
    ...
    str  F_AB_VENT 524 str F_AB_VENT6 525 str F_AB_NIUC 526 str F_AB_SURFAC 527 ///
...
using "nat2023us.AllCnty.txt" 

** Guardar los datos en formato Stata **
save "Nat2023.dta", replace
destring, replace
...
/* Note:
Used 2021 codebook to clean this data  
*/
...
lab var F_BFACIL"Reporting Flag for Birth Place" 
lab def F_BFACIL1 0 "Non-Reporting" 1 "Reporting"
lab val F_BFACIL F_BFACIL1
tab F_BFACIL, mi 
...
// Variable clearly exists and is the same, though, so using 2019 codebook 
// Variable XMRSTATE does not exist in 2023 data
...
// Variable clearly exists and is the same, though, so using 2019 codebook   
// Variable MRCITYFIPS does not exist in 2023 data
...
// Variable clearly exists and is the same, though, so using 2019 codebook 
// Variable CITYLIM Does not exist in 2023 data

// F_LIMIT - in 2019, not in 2021 codebook 
// Variable clearly exists and is the same, though, so using 2019 codebook 
// Variable F_LIMIT does not exist in 2023 data
...
lab var F_AB_NIUC "Reporting Flag for Admission to NICU" // typo in codebook: F_AB_NIUC
...
foreach x of varlist F_AB_VENT F_AB_VENT6 F_AB_NIUC F_AB_SURFAC F_AB_ANTIBIO F_AB_SEIZ { 
	lab def `x' 0 "Non-Reporting" 1 "Reporting" 
	lab val `x' `x'
	tab `x', mi
} 
...
save "C:\USA_Test\Nat2023.dta", replace 
