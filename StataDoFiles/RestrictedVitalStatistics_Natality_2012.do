clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2012.log, replace 
set more off
...
infix str VERSION 7 ///
	  ...
	  using "/FILEPATH/NATL2012US.AllCnty.txt"
...
save "/FILEPATH/RestrictedVitalStatistics_Natality_2012.dta", replace 
destring, replace
...
save "/FILEPATH/RestrictedVitalStatistics_Natality_2012_Labeled.dta", replace 
