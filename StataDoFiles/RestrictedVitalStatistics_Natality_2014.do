clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2014.log, replace 
set more off

** -----------------------------------------------; 
** This program reads the 2014 Restricted-Use  
** NCHS Natality Data File 
** by Hye Jee Kim, hyejk@stanford.edu,  Thur Nov 10, 2022 
...
infix str DOB_YY 9-12 str DOB_MM 13-14 str DOB_TT 19-22 str DOB_WK 23 ///
      str OSTATE 24-25 str XOSTATE 26-27 ///
	  str OCNTYFIPS 28-30 str OCNTYPOP 31 /// 
      str BFACIL 32 str F_FACILITY 33 str BFACIL3 50 /// 
	  str MAGE_IMPFLG 73 str MAGE_REPFLG 74 str MAGER 75-76 ///
      str MAGER14 77-78 str MAGER9 79 str MBCNTRY 80-81 str MBSTATE 82-83 /// 
	  str MBSTATE_REC 84 str MRCNTRY 85-86 str XMRSTATE 87-88 /// 
	  str MRSTATEPSTL 89-90 ///
	  ...
	  str MRACE31 105-106 str MRACE6 107 str MRACE15 108-109 str MBRACE 110 /// 
      str MRACEIMP 111 str MHISP_R 115 str F_MHISP 116 str MRACEHISP 117 ///
	  str MAR_P 119 str DMAR 120 str MAR_IMP 121 str F_MAR_P 123 /// 
	  str MEDUC 124 str F_MEDUC 126 /// 
	  str FAGERPT_FLG 142 /// 
	  str FAGECOMB 147-148 str FAGEREC11 149-150 /// 
	  ...
	  str F_RF_CESAR 335 str F_RF_NCESAR 336 str NO_RISKS 337 ///
	  str f_Eclampsia 338 /// 
	  ...
	  str APGAR10R 450 str F_APGAR10 451 /// 
	  ...
	  str GESTREC10 492-493 str GESTREC3 494 ///
	  str LMPUSED 498 ///
	  ...
	  using "/FILEPATH/NATL2014US.AllCnty.txt"

** The above line should contain
** the complete path and name of the raw data file.
	  
** The following line should contain the path to your output '.dta' (unlabeled) file ;
save "FILEPATH/RestrictedVitalStatistics_Natality_2014.dta", replace 
destring, replace

** Creating Variable Labels ** 

// Use only variables marked G (or just marked P)  
...
lab var F_FACILITY "Reporting Flag for Brith Place"
lab def F_FACILITY1 0 "Non-Reporting" 1 "Reporting"
lab val F_FACILITY F_FACILITY1
tab F_FACILITY, mi

lab var BFACIL3 "Facility Recode"
...
lab def RESTATUS1 1 "Resident" 2 "Intrastate/Intraterritory Nonresident" ///
		          3 "Interstate/Interterritory Nonresident" 4 "Foreign Resident"
...
// Prenatal Care
lab var PRECARE "Month Prenatal Care" 
...
foreach c of varlist CIG0_R CIG1_R CIG2_R CIG3_R {
	lab def `c'1 0 "Nonsmoker" 1 "1-5" 2 "6-10" 3 "11-20" 4 "21-40" 5 "41 or more" ///
...
lab var RF_INFTR "Infertility Treatment" // use reporting flag in field 319 for 2014
...
lab var f_Eclampsia "Reporting flag for Eclampsia Combined" //Flag for combined item in field 1334
lab def f_Eclampsia1 0 "Non-Reporting" 1 "Reporting" 
lab val f_Eclampsia f_Eclampsia1
tab f_Eclampsia, mi 
...
lab var APGAR10 "Ten Minute APGAR Score" // use reporting flag in field 126 for 2014 
lab def APGAR101 88 "Not applicable" 99 "Unknown or not stated"
lab val APGAR10 APGAR101 
tab APGAR10, mi
				
lab var APGAR10R "Ten Minute APGAR Score Recode" // use reporting flag in field 126 for 2014 
...
save "/FILEPATH/RestrictedVitalStatistics_Natality_2014_Labeled.dta", replace 
