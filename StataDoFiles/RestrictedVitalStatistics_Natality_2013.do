clear all 
capture log close
log using RestrictedVitalStatistics_Natality_2013.log, replace 
set more off
...
infix str VERSION 7 ///
	  ...
	  str MAGE_IMPFLG 87 MAGE_REPFLG 88 str MAGER 89-90 str MAGER14 91-92 ///
	  str MAGER9 93 ///
	  ...
	  str UFRACE 199-200 ///  
	  str PRIORTERM 208-209 ///
	  str LBO_REC 212 str TBO_REC 217 ///
	  ...
	  str RF_FEDRG 322 str RF_ARTEC 323 /// 
	  str RF_CESAR 324 str RF_CESARN 325-326 str RF_CES_BYP 327 ///
	  ...
	  str ME_PRES 392 str ME_ROUT 393 ///
	  str ME_TRIAL 394 ///
	  ...
	  str GESTREC3 455 str OBGEST_FLG 456 str GEST_IMP 457 ///
	  str COMPGST_IMP 458 /// 
	  str DBWT 463-466  ///
	  ...
	  str SetOrder_R 557 /// 
	  str F_MORIGIN 569 str F_FORIGIN 570 str F_MEDUC 571 str F_FEDUC 572 /// check starting here 
	  str F_CLINEST 573 ///
	  ...
	  str FRACE5E 1434 str FRACE6E 1437 str FRACE7E 1440 /// 
	  using "/FILEPATH/NATL2013US.AllCnty.txt"
	 
** The above line should contain
** the complete path and name of the raw data file.
	  
** The following line should contain the path to your output '.dta' (unlabeled) file ;
save "/FILEPATH/RestrictedVitalStatistics_Natality_2013.dta", replace 
destring, replace
...
save "/FILEPATH/RestrictedVitalStatistics_Natality_2013_Labeled.dta", replace 
